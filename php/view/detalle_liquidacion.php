...
<div class="col-md-12 grid-margin">
  <div class="row">
    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
      <h3 class="font-weight-bold">Detalle de liquidacion compra</h3>
    ...
    <div class="row mb-3">
        <div class="col-sm-10">         
            <a class="btn btn-default btn-sm" style="border: 1px solid;" href="lista_liquidacion.php"><i class="fa fa-arrow-left"></i> Regresar</a>
             ...
             <div class="col-sm-2">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                     ...
                     <label id="txt_estadoP" style="background:coral; color: white;" >Liquidacion no cobrada</label>
                    </div>       
                </div>
