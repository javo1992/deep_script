<?php
include('../modelo/lista_liquidacionM.php');
 ...
 * 
 */
$controlador = new lista_liquidacionC();
...
class lista_liquidacionC
{
  ...
  private $secuencial;
	...
	{
		$this->modelo = new lista_liquidacionM();
...
function DCTipoPago()
  ...
  function lista_facturas($parametros)
  {
    ...
    foreach($result as $key => $value)
    {
      ...
      $tr.='<tr>
              <td>
                <a class="btn-sm btn btn-primary" href="../controlador/facturar.php?reporte_liquidacion=true&empresa='.$_SESSION['INICIO']['ID_EMPRESA'].'&fac='.$value['id'].'&usu='.$_SESSION['INICIO']['ID_USUARIO'].'" target="_blank"><i class="fa fa-eye" title="Ver factura"></i></a>
                ';
  ...
  function add_articulos($parametros)
  {
   ...
   return  $this->modelo->add('lineas_liquidacion',$datos,$_SESSION['INICIO']['ID_EMPRESA']);
  ...
  function editar_linea($parametros)
  {
   ...
   return  $this->modelo->update('lineas_liquidacion',$datos,$where,$parametros['idEmp']);
  ...
  function delete_linea($parametros)
  {
    ...
    return $this->modelo->delete('lineas_liquidacion',$datos,$_SESSION['INICIO']['ID_EMPRESA']);
  }
...
function eliminarFac($parametros)
  {
    $empresa = $_SESSION['INICIO']['ID_EMPRESA'];
     $this->modelo->delete_lineas_liquidacion($empresa,$id=false,$parametros['id']);
  ...
  function pagada($parametros)
  {
    ...
    return $this->modelo->update('liquidacion_compras',$datosC,$datosCW,$_SESSION['INICIO']['ID_EMPRESA']);
