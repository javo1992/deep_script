...
function cargar_facturas()
{
    ...
    $.ajax({
        data:  {parametros:parametros},
        url:   '../controlador/lista_liquidacionC.php?lista_facturas=true',      
        type:  'post',
        dataType: 'json',
        success:  function (response) { 
...
function DCTipoPago() {
    ...
    $.ajax({
      //data:  {parametros:parametros},
      url:   '../controlador/lista_liquidacionC.php?DCTipoPago=true',
      type:  'post',
      dataType: 'json',
        success:  function (response) {
            //console.log(response);
...
function series()
{
    ...
    $.ajax({
        // data:  {parametros:parametros},
        url:   '../controlador/lista_liquidacionC.php?lista_serie=true',      
        type:  'post',
        dataType: 'json',
        success:  function (response) { 
...
{
    location.href="detalle_liquidacion.php?id="+id+"&estado="+estado;
}
...
function detalle_factura(id)
{
      $.ajax({
        data:  {id:id},
        url:   '../controlador/lista_liquidacionC.php?detalle_factura=true',      
        type:  'post',
        dataType: 'json',
        success:  function (response) { 
            console.log(response);
            ...
            {
                 $('#txt_estado').text('Liquidacion Autorizada');
            ...
            {
                 $('#txt_estado').text('Liquidacion pendiente');
            }
...
function lista_articulos()
{
    var parametros = 
    {
     ...
     $.ajax({
        data:  {parametros:parametros},
        url:   '../controlador/lista_liquidacionC.php?buscar_articulo=true',      
        type:  'post',
        dataType: 'json',
        success:  function (response) { 
...
function categorias()
  {
    $('#ddl_categoria').select2({
      ...
      ajax: {
        url:   '../controlador/lista_liquidacionC.php?categorias=true',  
        dataType: 'json',
        delay: 250,
...
function agregar_factura()
{
    ...
    if($('#txt_idpro').val()=='')
    {
     ...
     $.ajax({
        data:  {parametros:parametros},
        url:   '../controlador/lista_liquidacionC.php?add_articulo=true',      
        type:  'post',
        dataType: 'json',
        success:  function (response) { 
         if(response==1)
...
{     
  ...
  $.ajax({
    data:  {parametros:parametros},
    url:   '../controlador/lista_liquidacionC.php?delete_linea=true',      
    type:  'post',
    dataType: 'json',
    success:  function (response) { 
     if(response==1)
...
function pdf_factura()
  {
    ...
    var parametros = 
    {
     ...
     var url1= '../controlador/facturar.php?reporte_liquidacion=true&empresa='+empresa+'&fac='+id+'&usu='+usu+'&pago='+pago;
...
function eliminar(id)
{
    ...
    $.ajax({
        data: {parametros:parametros},
        url:   '../controlador/lista_liquidacionC.php?eliminar_fac=true',
        dataType:'json',      
        type:  'post',
        success:  function (response) { 
            console.log(response); 
            if(response==1)
            {
                location.href ='lista_liquidacion.php';
            }
        }
      });
}
...
function anular(id)
{
     $.ajax({
        data:  {id,id},
        url:   '../controlador/lista_liquidacionC.php?anular_factura=true',      
        type:  'post',
        dataType: 'json',
        success:  function (response) { 
            if(response==1)
...
function cambiar_serie()
{
    parametros = {
     ...
     $.ajax({
        data:  {parametros,parametros},
        url:   '../controlador/lista_liquidacionC.php?editar_serie=true',      
        type:  'post',
        dataType: 'json',
        success:  function (response) { 
            if(response==1)
...
function pagada(id)
{
     ...
     $.ajax({
        data:  {parametros,parametros},
        url:   '../controlador/lista_liquidacionC.php?pagada=true',      
        type:  'post',
        dataType: 'json',
        success:  function (response) { 
            if(response==1)
            {               
               Swal.fire("","La Liquidacion fue marcada como pagada","success").then(function(){
                    location.reload();
               })
            }
        }
